...
```bash
bash <(curl -s [https://raw.githubusercontent.com/QXIoa/pterodactyl-installer-revamped/master/install.sh](https://raw.githubusercontent.com/QXIoa/pterodactyl-installer-revamped/master/install.sh))
```
