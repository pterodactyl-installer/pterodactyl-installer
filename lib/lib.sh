...
# download URLs
export PANEL_DL_URL="https://github.com/yopi-def/panel/archive/refs/heads/master.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/yopi-def/pterodactyl-installer"}
