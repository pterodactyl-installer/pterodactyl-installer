...
# download URLs
export PANEL_DL_URL="https://github.com/pterodactyl/panel/releases/download/v1.10.1/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/pterodactyl/wings/releases/download/v1.7.0/wings_linux_amd64
